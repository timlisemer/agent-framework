...
describe("deriveAllowedToolsFromIntent", () => {
  const cases: Array<{ msg: string; expected: string[] }> = [
    ...
    { msg: "investigate correctly", expected: ["Bash"] },
    { msg: "look into the hook", expected: ["Bash"] },
    { msg: "search the repo", expected: ["Bash"] },
    { msg: "commit the changes", expected: ["mcp-commit"] },
    { msg: "push to origin", expected: ["mcp-push"] },
    { msg: "typecheck the project", expected: ["mcp-check"] },
    { msg: "run the build", expected: ["Bash", "mcp-check"] },
    { msg: "lint everything", expected: ["mcp-check"] },
