...
description: Commit staged changes and push through the agent-framework commit MCP tool with auto_push enabled. Use when the user invokes the agent-framework push workflow or asks for the old /push command equivalent.
---
