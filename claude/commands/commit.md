...
6. Call mcp__agent-framework__commit with:
   ...
   - extra_context: Build the context as follows:
     - If multiple repositories are being committed, prepend: "Note: This is part of a multi-repository commit. The user is committing changes to [N] repositories: [list the repo names]. You are currently evaluating: [current repo name]."
...
7. Report the result to the user for each repository:
